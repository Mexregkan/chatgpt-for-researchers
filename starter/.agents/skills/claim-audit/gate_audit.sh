...
#
# Usage:  bash .agents/skills/claim-audit/gate_audit.sh <script>
#         GATE=check bash .agents/skills/claim-audit/gate_audit.sh <script>   # other helper name
#         LABELCAP=80 bash .agents/skills/claim-audit/gate_audit.sh <script>  # tighter budget
#
