...
#
# Usage:  bash .agents/skills/doc-audit/selftest.sh
#
...
printf '# Project\n\n## Files\n- x\n' > "$R/AGENTS.md"
check "type: agent-guide" "$R/AGENTS.md" 0 'type detected +: agent-guide'
check "[10] fires on an agent guide with no Current status" "$R/AGENTS.md" 0 'no "Current status" section'
