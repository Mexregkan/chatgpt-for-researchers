...
#
# Usage:  bash .agents/skills/doc-audit/doc_lint.sh <file.tex|file.md> [--root <dir>]
...
#        the eight claim statuses in AGENTS.md
...
# ------------------------------------------------------------------ [2] untyped strength
print "--- [2] STRENGTH WORDS OUTSIDE A TYPED STATEMENT (AGENTS.md § Research-claim discipline)\n";
