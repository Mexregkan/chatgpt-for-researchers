---
name: check-pipeline
description: Drift check: verify every symbol, cell number, data file, and I/O claim in a Pipeline/ doc still matches the code; classify BROKEN vs STALE and fix the DOC on approval (the code is ground truth).
---
