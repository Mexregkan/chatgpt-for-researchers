...
reference). `AGENTS.md` holds the conventions and the running status.
...
- **Point, don't paste.** Cite `workbook.tex` labels / paper equations and `AGENTS.md`
  conventions; never paste large code blocks or generated numeric output — they rot.
